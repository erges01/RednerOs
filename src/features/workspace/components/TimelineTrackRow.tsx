...
export const TimelineTrackRow: React.FC<Props> = ({ track, timelineWidth }) => {
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    // Strict typing: Don't allow audio on video tracks
    if (asset.type !== track.type && track.type !== "text") {
       alert(`Cannot drop a ${asset.type} file into an ${track.type} track!`);
       return;
    }
